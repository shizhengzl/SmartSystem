<template>
  <div style="margin-left:12px;margin-top:5px;">
    ...
    <el-dialog title="编辑配置" :visible.sync="createdialog" :close-on-click-modal="false" :close-on-press-escape="false" @close="reset">
...
<script>
import { getHeader, GetResult, Save, Remove } from '@/api/sqlconfig'
