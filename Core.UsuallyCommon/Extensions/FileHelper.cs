...
namespace Core.UsuallyCommon
{
    public class FileHelper
    {
        ...
        /// 复制文件
        /// </summary>
        /// <param name="src">复制目标文件</param>
        /// <param name="dst">复制到目录</param>
            ...
            if (Directory.Exists(root))
            {
                ...
                foreach (var dir in dirList)
                {
                    ...
                    dirInfo.GetFiles().ToList().ForEach(f =>
                    {
                        ...
                        if(string.IsNullOrWhiteSpace(extension) || (!string.IsNullOrWhiteSpace(extension) && f.Extension == (extension.Contains(".") ? extension : "." + extension)))
                             list.Add(f.FullName);
                    });
                } 
